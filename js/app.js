class UI {
  constructor() {
    ...
    addExpense(expense){   
        ...
        div.innerHTML = `<div class="expense-item d-flex align-items-baseline"><h6 id="kol" class="expense-title mb-0  list-item font-italic">${expense.title}</h6><h6 id="kol1" class="expense-amount mb-0 list-item font-italic">${expense.amount}</h6><div  class="expense-icons list-item"><a id="kol2" class="delete-icon text-danger" data-id="${expense.id}"><i class="fas fa-trash"></i></a></div></div>`;
